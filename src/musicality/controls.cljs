...
(defn key-down-handler
  ...
  [key-state {:keys [left-fn up-fn right-fn down-fn space-fn enter-fn p-fn n-fn r-fn v-fn]
              :or {left-fn (constantly true)
                   ...
                   n-fn (constantly true)
                   r-fn (constantly true)
                   v-fn (constantly true)}}]
